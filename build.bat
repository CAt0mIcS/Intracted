...
IF %architecture%==x64 (
	call cmake .. -DCMAKE_BUILD_TYPE=%configuration% -A x64 -DITC_ARCHITECTURE=%architecture%
)
IF %architecture%==x86 (
	call cmake .. -DCMAKE_BUILD_TYPE=%configuration% -A Win32 -DITC_ARCHITECTURE=%architecture%
)
